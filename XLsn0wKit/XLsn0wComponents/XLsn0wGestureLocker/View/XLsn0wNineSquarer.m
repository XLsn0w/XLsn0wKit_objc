...
- (void)initSubviews {
    ...
    for (NSInteger i = 0; i < 9; i++) {
        ...
        [btn setImage:[XLsn0wer getCustomBundleWithFileName:@"XLsn0wKit_objc" bundleImageName:@"gesture_normal"] forState:UIControlStateNormal];
        [btn setImage:[XLsn0wer getCustomBundleWithFileName:@"XLsn0wKit_objc" bundleImageName:@"gesture_selected"] forState:UIControlStateSelected];
        [self addSubview:btn];
        btn.tag = i + 1;
    }
}
