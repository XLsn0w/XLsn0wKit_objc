...
@implementation XLsn0wQRCodeLogo
...
+ (XLsn0wQRCodeLogo *)codeImageWithString:(NSString *)string
                                size:(CGFloat)width
{
    CIImage *ciImage = [XLsn0wQRCodeLogo xlsn0wpay_createQRForString:string];
    if (ciImage) {
        return [XLsn0wQRCodeLogo createNonInterpolatedUIImageFormCIImage:ciImage
                                                               size:width];
    } else {
        return nil;
    }
...
+ (XLsn0wQRCodeLogo *)createNonInterpolatedUIImageFormCIImage:(CIImage *)image
                                                    size:(CGFloat)size {
    ...
    return (XLsn0wQRCodeLogo *)[UIImage imageWithCGImage:scaledImage];
}
                                       ...
                                       color:(UIColor *_Nullable)color;
{
    ...
    XLsn0wQRCodeLogo *image = [XLsn0wQRCodeLogo codeImageWithString:string size:width];
    ...
    XLsn0wQRCodeLogo *resultUIImage = (XLsn0wQRCodeLogo *)[UIImage imageWithCGImage:imageRef];
...
+ (XLsn0wQRCodeLogo *_Nonnull)codeImageWithString:(NSString *_Nullable)string
    ...
    XLsn0wQRCodeLogo *bgImage = [XLsn0wQRCodeLogo codeImageWithString:string
                                                       size:width
                                                      color:color];
    ...
    return (XLsn0wQRCodeLogo *)newImage;
}
